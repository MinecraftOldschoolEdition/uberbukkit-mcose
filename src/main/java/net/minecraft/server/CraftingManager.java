...
public class CraftingManager {
    ...
    private CraftingManager() {
        ...
        if (UberbukkitConfig.getInstance().getBoolean("mechanics.old_slab_recipe", false)) {
            ...
            this.registerShapedRecipe(new ItemStack(Block.STEP, 3, 5), new Object[] { "###", Character.valueOf('#'), Block.STONE_BRICK });
        } else {
        ...
        // Book and Quill recipe: Book + Ink Sac + Feather
        this.registerShapelessRecipe(new ItemStack(Item.WRITABLE_BOOK, 1), new Object[] { Item.BOOK, new ItemStack(Item.INK_SACK, 1, 0), Item.FEATHER });
        this.registerShapelessRecipe(new ItemStack(Item.MELON_SEED, 1), new Object[] { Item.MELON_SLICE });
        this.registerShapelessRecipe(new ItemStack(Item.PUMPKIN_SEED, 4), new Object[] { new ItemStack(Block.PUMPKIN, 1, -1) });
        ...
        // Fence Gate: sticks on sides, planks in the middle (two rows)
        this.registerShapedRecipe(new ItemStack(Block.FENCE_GATE, 1), new Object[] { "SWS", "SWS", Character.valueOf('S'), Item.STICK, Character.valueOf('W'), Block.WOOD });
        ...
        this.registerShapedRecipe(new ItemStack(Item.LEAD, 2), new Object[] { "## ", "#X ", "  #", Character.valueOf('#'), Item.STRING, Character.valueOf('X'), Item.SLIME_BALL });
        ...
        this.registerShapedRecipe(new ItemStack(Block.STONE_BRICK_STAIRS, 4), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), Block.STONE_BRICK });
