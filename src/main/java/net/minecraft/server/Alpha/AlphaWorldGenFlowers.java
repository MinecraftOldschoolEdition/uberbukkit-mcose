...
public class AlphaWorldGenFlowers extends WorldGenerator {
	...
	private BlockStateKey plantState;

	public AlphaWorldGenFlowers(int var1) {
		this.plantBlockId = var1;
		this.plantState = stateFromBlockId(var1);
	}

	public AlphaWorldGenFlowers(String blockId) {
		this.plantState = stateFromIdentifier(blockId);
		this.plantBlockId = BlockStateBridge.toLegacy(this.plantState).blockId;
	}
	...
	public boolean a(World var1, Random var2, int var3, int var4, int var5) {
		for (int var6 = 0; var6 < 64; ++var6) {
			...
			if (var1.getTypeId(var7, var8, var9) == 0 && ((BlockFlower)Block.byId[this.plantBlockId]).f(var1, var7, var8, var9)) {
				setGeneratedBlock(var1, var7, var8, var9, this.plantState);
			}
		}
