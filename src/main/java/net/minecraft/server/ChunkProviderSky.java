...
public class ChunkProviderSky implements IChunkProvider {
    ...
    private boolean generateForestySkyCascadeFeature(int i, int j) {
        ...
        if (this.p.isEmpty(j3, l3, k3)) {
            this.p.setBlockStateAndData(j3, l3, k3, "minecraft:water");
        }
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        ...
        for (i2 = 0; i2 < 2; ++i2) {
            ...
            (new WorldGenFlowers("minecraft:dandelion")).a(this.p, this.j, j2, k2, l2);
        }
        ...
        if (this.j.nextInt(2) == 0) {
            ...
            k2 = l + this.j.nextInt(16) + 8;
            (new WorldGenFlowers("minecraft:poppy")).a(this.p, this.j, i2, j2, k2);
        }
        ...
        if (this.j.nextInt(4) == 0) {
            ...
            j2 = this.j.nextInt(128);
            k2 = l + this.j.nextInt(16) + 8;
            (new WorldGenFlowers("minecraft:brown_mushroom")).a(this.p, this.j, i2, j2, k2);
        }
