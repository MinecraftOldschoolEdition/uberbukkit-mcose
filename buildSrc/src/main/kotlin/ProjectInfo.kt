...
val Project.homepageUrl: String get() = properties["homepageUrl"].toString()
val Project.issueUrl: String get() = properties["issueUrl"].toString()
val Project.sourceUrl: String get() = properties["sourceUrl"].toString()
